...
public class AuthorTest extends TestCase {
	...
	public void testDirectories() {
		...
		new CvsRevision(file1, "1.1", CvsRevision.TYPE_CREATION, author2, date, null, 0, 0, 0, null);
		new CvsRevision(file2, "1.2", CvsRevision.TYPE_CHANGE, author1, date, null, 0, 0, 0, null);
		new CvsRevision(file2, "1.1", CvsRevision.TYPE_CREATION, author1, date, null, 0, 0, 0, null);
		new CvsRevision(file3, "1.1", CvsRevision.TYPE_CREATION, author2, date, null, 0, 0, 0, null);
		new CvsRevision(file4, "1.1", CvsRevision.TYPE_CREATION, author1, date, null, 0, 0, 0, null);
	...
	public void testRevisions() {
		...
		CvsRevision rev13 = new CvsRevision(file1, "1.3", CvsRevision.TYPE_CHANGE, author, date3, null, 0, 0, 0, null);
		CvsRevision rev12 = new CvsRevision(file1, "1.2", CvsRevision.TYPE_CHANGE, author, date2, null, 0, 0, 0, null);
		CvsRevision rev11 = new CvsRevision(file1, "1.1", CvsRevision.TYPE_CREATION, author, date1, null, 0, 0, 0, null);
		CvsRevision rev21 = new CvsRevision(file2, "1.1", CvsRevision.TYPE_CREATION, author, date2, null, 0, 0, 0, null);
