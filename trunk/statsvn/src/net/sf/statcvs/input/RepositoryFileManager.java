 ...
 * 
 * New in StatSVN: Also provides a central point of access to abstract out calls to the server. Many of the methods here simply redirect to the static
 * util/SvnXXXUtils classes. Therefore, clients don't have to know where the information is located, they can simply invoke this class.
 * 
