/*
	...
	$Name:  $ 
	Created on $Date: 2003/06/04 16:19:38 $ 
*/
...
/**
 * Test cases for {@link net.sf.statsvn.util.FileUtils}
 *
 * @author Richard Cyganiak
 * @version $Id: FileUtilsTest.java,v 1.2 2003/06/04 16:19:38 cyganiak Exp $
 */
public class FileUtilsTest extends TestCase {
	...
	public void testGetParentDirectoryPath() {
		assertEquals("net/sf/",
				FileUtils.getParentDirectoryPath("net/sf/statcvs/"));
		assertEquals("net/",
				FileUtils.getParentDirectoryPath("net/sf/"));
