 ...
 * @version $Id: AllTests.java,v 1.3 2002/08/23 02:03:59 cyganiak Exp $
 */
public class AllTests {
	...
	public static Test suite() {
		final TestSuite suite = new TestSuite("Test for net.sf.statcvs.util");
		// $JUnit-BEGIN$
		...
		suite.addTest(new TestSuite(SvnInfoUtilsTest.class));
		// $JUnit-END$
		return suite;
	}
}
