 ...
 * 
 * <p>
 * First, {@link #buildModule} will be called with the name of the module. Then, {@link #buildFile} will be called with the filename and other pieces of
 * information of the first file in the log. Then, for every revision of this file, {@link #buildRevision} is called. The calls to <tt>buildFile</tt> and
 * <tt>buildRevision</tt> are repeated for every file in the log.
 * </p>
 * 
 * <p>
 * The files are in no particular order. The revisions of one file are ordered by time, beginning with the <em>most recent</em>.
 * </p>
 * 
...
public interface SvnLogBuilder {
     ...
     * 
     * @param filename
     *            the file's name with path relative to the module, for example "path/file.txt"
     * @param isBinary
