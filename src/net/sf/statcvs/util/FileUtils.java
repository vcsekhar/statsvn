...
public class FileUtils {
    ...
    /**
     * Deletes the ending directory separator of a given <code>path</code> if there is one and returns the result. Otherwise the path is unhandled returned.
     * 
     * <p>
     * The separator is the one used bye the underlying operating system and it is the one returned bye the <code>getDirSeparator()</code> method.
     * 
     * @param path
    ...
    /**
     * Concatenates <code>path</code> and filename to an absolute filename by inserting the system file separator.
     * 
     * @param path
     *            The path to use.
     * @param filename
